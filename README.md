...
[![Programming languages](https://skillicons.dev/icons?i=js,html,angular,java,spring,cs,css,c,vue,wasm,dotnet,linux,vim,ts,react,jquery,lua,aws,gcp,azure,rust,kafka,rabbitmq,sqs&perline=5&theme=light)](https://skillicons.dev)
